        ...
        <button
          ...
          className={`px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-colors ${
            categoriaAtiva === 'todos'
              ? 'bg-vinho text-creme'
              : 'bg-white text-vinho border border-gray-200 hover:border-vinho'
          }`}
        >
          Todos
        </button>
...
export default function ProdutosPage() {
  return (
    <Suspense fallback={<div className="text-center py-20 text-vinho/50">Carregando...</div>}>
      <ProdutosContent />
    </Suspense>
  )
}
